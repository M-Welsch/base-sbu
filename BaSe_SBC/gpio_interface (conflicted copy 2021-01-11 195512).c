...
void set_all_display_pins_to_input(void) {
	dis_data_port.DIRCLR = (dis_db4 | dis_db5 | dis_db6 | dis_db7);
	dis_e_port.DIRCLR = dis_e;
	dis_rs_port.DIRCLR = dis_rs;
}

void set_all_display_pins_to_output(void) {
	dis_data_port.DIRSET = (dis_db4 | dis_db5 | dis_db6 | dis_db7);
	dis_e_port.DIRSET = dis_e;
	dis_rs_port.DIRSET = dis_rs;	
}
